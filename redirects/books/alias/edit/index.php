<?php
    ...
    if($_SERVER['REMOTE_ADDR'] != $ip1 && $_SERVER['REMOTE_ADDR'] != $ip2 && $_SERVER['REMOTE_ADDR'] != $ip3) {
        ...
        $book = "SELECT a.book_id, c.domain, a.domain_id, d.sub, a.sub_id, b.title
        ...
        $domain_id = $book_info['domain_id'];
        $sub_id = $book_info['sub_id'];
...
?>
        <div class="container-fluid">
            <div class="row">
                ...
                <div class="col-sm-12 col-md-6">
                    <div class="jumbotron">
                        <h1>Edit Alias</h1>
                        <p>This alias is for the book <strong><?php echo $title; ?></strong></p>
                        <ol class="breadcrumb">
                            ...
                            <li class="breadcrumb-item"><a href="http://apps.emcp.com/redirects/books/<?php echo $book_id; ?>"><?php echo $book_info['title']; ?></a></li>
                            <li class="breadcrumb-item"><a href="http://apps.emcp.com/redirects/books/alias/manage/<?php echo $id; ?>">Alias</a></li>
                    ...
                    <div class="row">
                        <form class="form-horizontal">
                            ...
                            <div class="hidden">
                                <input id="alias-domain-id" value="<?php echo $domain_id; ?>" />
                                <input id="alias-sub-id" value="<?php echo $sub_id; ?>" />
                            </div>
        ...
        <script>
            $(document).ready(function() {
                ...
                $d_id = $('#alias-domain-id').val();
                $s_id = $('#alias-sub-id').val();
                
                $('select#domain-choice').val($d_id);
                $('select#sub-choice').val($s_id);
                ...
                $('form').submit(function(e) {
                    ...
                    $.ajax({
                        method: "POST",
                        url: "http://apps.emcp.com/redirects/includes/update_book_alias.php",
                        data: { 
                            id: '<?php echo $id; ?>',
                ...
                $(document).on('click','.redirect-to-alias',function() {
                    window.location = '/redirects/books/alias/manage/<?php echo $id; ?>';
                });
